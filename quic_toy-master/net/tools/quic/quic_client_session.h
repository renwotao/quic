...
class QuicClientSession : public QuicSession, public QuicCryptoClientStream::ProofHandler {
 public:
  ...
  virtual ReliableQuicStream* CreateOutgoingDynamicStream(SpdyPriority priority) { return nullptr; };
