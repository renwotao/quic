...
//#include "base/memory/std::unique_ptr.h"
...
class QuicDispatcher : public QuicServerSessionVisitor,
 ...
 public:
  ...
  QuicDispatcher(const QuicConfig& config,
                 ...
                 /*QuicPacketWriterFactory* factory_writer,*/
 ...
 private:
  ...
  void CleanUpSession(SessionMap::iterator it, bool should_close_statelessly);
  ...
  //std::unique_ptr<PacketWriterFactory> packet_writer_factory_;
  ...
  QuicFramer framer_;
  std::unique_ptr<QuicFramerVisitor> framer_visitor_;
